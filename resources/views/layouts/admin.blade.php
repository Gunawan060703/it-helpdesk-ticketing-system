...
<head>
    ...
    <title>@yield('title') - Admin IT Helpdesk Hotel Loccal Collection</title>
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-user">
            ...
            <div class="user-name">{{ Auth::user()->full_name ?? Auth::user()->name ?? 'User' }}</div>
            <div class="user-role">
                <span class="badge" style="background: rgba(255,255,255,0.2);">
                    {{ Auth::user()->role == 'admin' ? 'Administrator' : (Auth::user()->role == 'staff' ? 'Staff' : 'User') }}
                </span>
            </div>
        </div>
        ...
        <div class="sidebar-footer">
            <a href="{{ route('admin.profile') }}" class="logout-btn" style="margin-bottom: 8px;">
            ...
            <div class="navbar-right">
                ...
                <div class="dropdown">
                    <div class="user-dropdown" data-bs-toggle="dropdown" aria-expanded="false">
                        <div class="user-info">
                            <div class="user-name-small">{{ Auth::user()->full_name ?? Auth::user()->name ?? 'User' }}</div>
                            <div class="user-role-small">{{ Auth::user()->role == 'admin' ? 'Administrator' : (Auth::user()->role == 'staff' ? 'Staff' : 'User') }}</div>
                        </div>
