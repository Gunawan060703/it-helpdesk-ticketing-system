...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo e(route('user.store-ticket')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                   value="<?php echo e(old('title')); ?>" placeholder="Contoh: Komputer tidak bisa menyala" required>
...
unset($__errorArgs, $__bag); ?>" 
                                      placeholder="Jelaskan masalah yang dialami secara detail..." required><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" required>
                                <option value="Low" <?php echo e(old('priority') == 'Low' ? 'selected' : ''); ?>>Low - Normal (Tidak mendesak)</option>
                                <option value="Medium" <?php echo e(old('priority') == 'Medium' ? 'selected' : ''); ?>>Medium - Penting (Mempengaruhi pekerjaan)</option>
                                <option value="High" <?php echo e(old('priority') == 'High' ? 'selected' : ''); ?>>High - Kritis (Mengganggu operasional)</option>
                            </select>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\it-helpdesk\resources\views/user/create-ticket.blade.php ENDPATH**/ ?>