...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> - IT Helpdesk Hotel Loccal Collection</title>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-nav">
            ...
            <div class="nav-section">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('user.create-ticket') ? 'active' : ''); ?>" 
                           href="<?php echo e(route('user.create-ticket')); ?>">
                            <i class="bi bi-plus-circle"></i>
                            <span>Buat Tiket Baru</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('user.my-tickets*') ? 'active' : ''); ?>" 
                           href="<?php echo e(route('user.my-tickets')); ?>">
        ...
        <div class="sidebar-footer">
            <a href="<?php echo e(route('user.profile')); ?>" class="logout-btn" style="margin-bottom: 10px;">
            ...
            <div class="navbar-right">
                <div class="dropdown">
                    <div class="user-dropdown" data-bs-toggle="dropdown">
                        <div class="user-info">
                            <div class="user-name-small"><?php echo e(Auth::user()->full_name); ?></div>
...
</html><?php /**PATH D:\it-helpdesk\it-helpdesk\resources\views/layouts/user.blade.php ENDPATH**/ ?>