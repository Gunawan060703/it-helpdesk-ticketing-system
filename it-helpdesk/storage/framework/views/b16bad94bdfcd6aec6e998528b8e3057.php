        ...
        <div class="card bg-primary-gradient text-white">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h3 class="mb-1">Selamat Datang, <?php echo e(Auth::user()->full_name); ?>!</h3>
    ...
    <div class="col-xl-3 col-md-6 mb-3">
        <div class="card stat-card bg-warning-gradient text-white">
            <div class="card-body">
                ...
                <div class="stat-value"><?php echo e($stats['open'] + $stats['in_progress']); ?></div>
        ...
        <div class="card h-100">
            ...
            <div class="card-body">
                <div class="d-grid gap-3">
                    <a href="<?php echo e(route('user.create-ticket')); ?>" class="btn btn-gradient btn-lg">
                        <i class="bi bi-plus-circle"></i> Buat Tiket Baru
                    </a>
                    <a href="<?php echo e(route('user.my-tickets')); ?>" class="btn btn-outline-primary btn-lg">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-<?php echo e($ticket->priority == 'High' ? 'danger' : ($ticket->priority == 'Medium' ? 'warning' : 'success')); ?>">
                                            <?php echo e($ticket->priority); ?>

                                        </span>
                                    </td>
                                    <td>
                                        <span class="badge bg-<?php echo e($ticket->status == 'Open' ? 'danger' : ($ticket->status == 'In Progress' ? 'warning' : ($ticket->status == 'Resolved' ? 'success' : 'secondary'))); ?>">
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('user.ticket.detail', $ticket->id)); ?>" class="btn btn-sm btn-outline-primary">
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\it-helpdesk\it-helpdesk\resources\views/user/dashboard.blade.php ENDPATH**/ ?>