...
unset($__errorArgs, $__bag); ?>" required>
                                <option value="user" <?php echo e(old('role') == 'user' ? 'selected' : ''); ?>>User (Karyawan)</option>
                                <option value="admin" <?php echo e(old('role') == 'admin' ? 'selected' : ''); ?>>Admin (IT Support)</option>
                            </select>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\it-helpdesk\resources\views/admin/create-user.blade.php ENDPATH**/ ?>